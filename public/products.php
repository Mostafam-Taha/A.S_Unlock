...
<body>
    ...
    <section class="products-shop-con">
        <div class="container">
            <div class="offic">
                <h1>المنتجات</h1>
                <!-- <p>وصف للمنتجات ... .</p> -->
                <!-- لو انت يا أبو الشافي حابب تضيف الوصف ضيفه انت عشان انا مكسل بسراحة -->
            </div>
                        ...
                        <div class="product">
                            <div class="container">
                                <div class="grid-pr">
                                    ...
                                    // استعلام لاسترجاع المنتجات المنشورة فقط
                                    $stmt = $pdo->query("SELECT * FROM digital_products WHERE is_published = 1");
    ...
    <div id="productModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body"> <!-- تم إضافة هذا العنصر الجديد -->
