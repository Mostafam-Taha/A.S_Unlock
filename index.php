...
<body>
    ...
    <section class="home">
        ...
        <div class="container">
            ...
            <div class="ho-btn">
                ...
                <a href="#" id="contact" class="btn-sc">تواصل معنا</a>
            </div>
        </div>
    </section>
    <div class="wave">
    ...
    <section class="team">
        <div class="container">
            ...
            <div class="team-pers">
                <div class="grid-team">
                    <img src="./assets/image//Team 648942318.jpeg" alt="Not Found Team" loading="lazy">
                    <div class="data-team">
                        <h4 class="name">Ahmed waleed</h4>
                        <span class="job">CEO</span>
                    </div>
                </div>
                <div class="grid-team">
                    <img src="./assets/image/CEO.jpeg" alt="Not Found Team" loading="lazy">
                    <div class="data-team">
                        <h4 class="name">Ahmed Abd Elshafy</h4>
                        <span class="job">CEO</span>
                    </div>
                </div>
                <div class="grid-team">
                    <img src="./assets/image/Team 4841324322.jpeg" alt="Not Found Team" loading="lazy">
                    <div class="data-team">
                        <h4 class="name">Mohamed Ayman</h4>
                        <span class="job">CEO</span>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        emailjs.init('OL-bmAupqH0hzZS0X'); // استبدل بالقيمة الصحيحة
        
        // تعريف المتغيرات في النطاق العام
        const serviceID = 'service_0v2rxhh'; // استبدل بالقيمة الصحيحة
        const templateID = 'template_9qfoidp'; // استبدل بالقيمة الصحيحة
