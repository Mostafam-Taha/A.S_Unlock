    ...
    <style>
        ...
        * {
        ...
        .btn-outline {
            ...
            border: 1px solid var(--br-color-h-p);
            color: var(--br-color-h-p);
            transition: all 0.3s ease;
        }
...
<body>
    ...
    <div class="profile-header">
        <h1>الملف الشخصي</h1>
        <p>إدارة معلومات حسابك الشخصية وتخصيص الإعدادات</p>
    </div>
    ...
    <div class="profile-card">
        <div class="profile-content">
            ...
            <div class="profile-info">
                <div class="info-item">
                    <h3><i class="fas fa-user"></i> اسم المستخدم</h3>
                    <p><?php echo htmlspecialchars($admin['username'] ?? 'غير محدد'); ?></p>
                </div>
                
                <div class="info-item">
                    <h3><i class="fas fa-envelope"></i> البريد الإلكتروني</h3>
                    <p><?php echo htmlspecialchars($admin['email'] ?? 'غير محدد'); ?></p>
                </div>
                
                <div class="info-item">
                    <h3><i class="fas fa-clock"></i> آخر تسجيل دخول</h3>
                    <p>
                        <?php 
                        if ($admin['last_login']) {
                            echo date('Y-m-d H:i', strtotime($admin['last_login']));
                        } else {
                ...
                <div class="info-item">
                    <h3><i class="fas fa-calendar"></i> تاريخ الإنشاء</h3>
                    <p><?php echo date('Y-m-d', strtotime($admin['created_at'])); ?></p>
                </div>
            </div>
        </div>
